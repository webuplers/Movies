...
<div class="container">    
  ...
  <div class="loadMore"><input type="hidden" id="pageno" value=""/><input type="hidden" id="currentpage" value="0"/><a href="javascript:void(0);" class="loadMovie">Load More</a></div>
