...
function fn_movies_filter(){
	...
	echo $total_rows = $movies_data['@attributes']['totalResults'];
    echo $total_pages = ceil($total_rows / $no_of_records_per_page);exit;
    // echo '<pre>';
	...
	if (! empty($movies_data['result'])) :
		foreach ($movies_data['result'] as $row) :
			...
			$movieData .= '<div class="col-lg-3 equalHeight">
