...
function fn_movies_filter(){
	...
	$apiKey = "6f30f377";
    echo $api_endpoint = "https://www.omdbapi.com/";
    $dev_env = false;
    $movieArray = [
    "apikey" => $apiKey,
    "r" => "xml",
    ...
    $properties_xml_data = simplexml_load_file($query);
    $properties_parse_data = json_encode($properties_xml_data);
    $properties_data = json_decode($properties_parse_data, true);
    
    echo '<pre>';
    print_r($properties_parse_data);
	// if (! empty($properties_data['listings']['listing'])) :
	// 	foreach ($properties_data['listings']['listing'] as $pba) :
	// echo json_encode(array(
	// 	'movies' => json_encode($properties_xml_data),
	// ));	
