...
function fn_movies_filter(){
	...
	if (! empty($movies_data['result'])) :
		foreach ($movies_data['result'] as $row) :
			...
			echo '<div class="col-sm-4 equalHeight">
					<div class="panel panel-primary">
					'.(!empty($title) ? '<div class="panel-heading">'.$title.'</div>' : '').'
					'.(!empty($poster) ? '<div class="panel-body" ><img style="text-align:center;" src="'.$poster.'" class="img-responsive" alt="Image" /></div>' : '').'
