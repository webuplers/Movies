 ...
 *** Movie filter Script ***
 ***************************/
//add_action( 'wp_enqueue_scripts', 'movie_script_enqueuer' );
function movie_script_enqueuer() {
        wp_register_script( "movie-filter-script", get_template_directory_uri().'/js/movie-filter.js', array(), wp_get_theme()->get( 'Version' ), true);
        wp_localize_script( 'movie-filter-script', 'blog_filter_ajax_params', array( 			
